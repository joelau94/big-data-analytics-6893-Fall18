...
FMAP = [
    ...
    'avgstar',
    # business features
    'zip_code', 'stars', 'c0fav', 'c3fav', 'c2fav', 'c9fav', 'c13fav',
...
def display(importances, std, acc, fig_path, top_n_features=None):
  ...
  plt.figure()
  plt.title(title)
  plt.bar(range(top_n_features), importances[indices],
          color='r', yerr=std[indices], align='center')
  plt.gcf().subplots_adjust(bottom=0.25)
  plt.xticks(range(top_n_features), feature_names, rotation='vertical')
